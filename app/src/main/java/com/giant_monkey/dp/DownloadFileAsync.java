...
/**
 * Created by 2525j on 2017-01-08.
 */
...
public class DownloadFileAsync extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            OutputStream output = new FileOutputStream("/sdcard/DCIM/"+params[1].toString());
            ...
            while ((count = input.read(data)) != -1) {
                total += count;
                publishProgress("progress","" + (int) total, params[1].toString());
            ...
            output.close();
            input.close();
            publishProgress("" + (int) lenghtOfFile);
    ...
    protected void onPostExecute(String unused) {
        ...
        ((MainActivity)mContext).nextdownload();
    }
}